...
function onHeaderClick(event) {
  ...
  headerMenu.classList.toggle("is-closed"); // headerBurger.setAttribute("src", "/images/menu-close.png");

  headerBurger.classList.toggle("burger-close"); // body.classList.toggle("menu-open");
} // Закрытие меню по нажатию на якорь


$(".header-menu-item").click(function () {
  $(".header-menu").addClass("is-closed"), $(".header-burger").removeClass("burger-close");
});
